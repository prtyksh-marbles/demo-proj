      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-[1fr_1.4fr_1fr] gap-4 items-center relative z-10">
        ...
        <div className="flex flex-col gap-16 lg:pr-2">
          <div className="text-center">
            <div className="mx-auto mb-3 text-[#2848aa] flex items-center justify-center">
            ...
            <h3 className="text-[#132758] text-[1.25rem] font-semibold mb-2 tracking-tight">Targeted brain stimulation</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-[#132758] text-[1.25rem] font-semibold mb-2 tracking-tight">Real-time brain tracking</h3>
        ...
        <div className="flex flex-col items-center justify-center my-10 lg:my-0">
          ...
          <div className="flex justify-center items-center gap-4 relative z-20">
            <button className="bg-[#132758] text-white px-7 py-3 rounded-full font-semibold text-[0.75rem] tracking-wide hover:bg-[#1a3579] transition-all duration-300 flex items-center gap-2 shadow-[0_10px_20px_rgba(19,39,88,0.2)] hover:shadow-[0_15px_30px_rgba(19,39,88,0.3)] hover:-translate-y-0.5 uppercase">
            ...
            <button className="bg-white/80 backdrop-blur-md text-[#132758] border border-[#132758]/10 px-7 py-3 rounded-full font-semibold text-[0.75rem] tracking-wide hover:bg-gray-50 transition-all duration-300 flex items-center gap-2 shadow-sm hover:shadow-md hover:-translate-y-0.5 uppercase">
        ...
        <div className="flex flex-col gap-16 lg:pl-2">
          <div className="text-center">
            ...
            <h3 className="text-[#132758] text-[1.25rem] font-semibold mb-2 tracking-tight">Guided cognitive exercises</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-[#132758] text-[1.25rem] font-semibold mb-2 tracking-tight">Safe and CDSCO-approved</h3>
